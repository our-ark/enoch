...
class EnochTelegramTests(unittest.TestCase):
    ...
    def test_help_lists_safe_commands(self) -> None:
        ...
        self.assertIn("/task cancel <id> - cancel a queued background task", client.sent[0][1])
        ...
        self.assertIn("/backlog remove <id> - remove a pending backlog item", client.sent[0][1])
        self.assertIn("/backlog priority <id> p0|p1|p2 - reprioritize backlog work", client.sent[0][1])
        ...
        self.assertIn("/evolve schedule once a day - run evolve once per day", client.sent[0][1])
    ...
    def test_help_evolve_shows_evolve_usage(self) -> None:
        ...
        self.assertIn("/evolve schedule once a day", reply)
